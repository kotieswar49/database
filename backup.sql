...
INSERT INTO `client` VALUES (101,'Big Business Federation','123 Falschungstraße, 10999 Berlin','NGO'),(102,'eCommerce GmbH','27 Ersatz Allee, 10317 Berlin','Retail'),(103,'AutoMaker AG','20 Künstlichstraße, 10023 Berlin','Auto'),(104,'Banko Bank','12 Betrugstraße, 12345 Berlin','Banking'),(105,'WeMoveIt GmbH','138 Arglistweg, 10065 Berlin','Logistics');
...
CREATE TABLE `teacher` (
  ...
  `language_1` varchar(5) NOT NULL,
  `language_2` varchar(5) DEFAULT NULL,
...
-- Dump completed on 2024-07-02 14:10:42
